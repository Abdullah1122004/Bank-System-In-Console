...
private:
    ...
    {
        string LoginRocord = "";
        LoginRocord += clsDate::GetSystemDateTimeString() + Separator;
        LoginRocord += UserName + Separator;
        LoginRocord += clsUtil::EncryptText(Password) + Separator;
        LoginRocord += to_string(Permissions);
        return LoginRocord;
    } 
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string line, string Delim = "#//#")
    {
        ...
        vector <string> vLoginRegisterDataLine = clsString::Split(line, Delim);
        LoginRegisterRecord.Date_Time = vLoginRegisterDataLine[0];
...
public:
    ...
    enum enPermissions{eAll = -1, pListClients = 1, pAddNewClient = 2, 
    pDeleteClient = 4, pUpdateClients = 8, pFindClient = 16, pTransactions = 32,
    ...
    bool CheckAcessPermissions(enPermissions Permission)
    {
